...
components = [
    ('Lead_sources_master.jsx', 'LeadSourcesMaster', 'LeadSource', 'Lead Sources'),
    ('Industries_master.jsx', 'IndustriesMaster', 'Industry', 'Industries'),
    ('Oppurtunity_Stages_master.jsx', 'OpportunityStagesMaster', 'OpportunityStage', 'Opportunity Stages'),
    ('Activity_Types_master.jsx', 'ActivityTypesMaster', 'ActivityType', 'Activity Types'),
    ('Owners_master.jsx', 'OwnersMaster', 'Owner', 'Owners')
]

for filename, comp_name, category, disp_name in components:
    filepath = os.path.join(r'd:\OFFICIAL\CRM\React\src\pages', filename)
    with open(filepath, 'w') as f:
        f.write(template.replace('{component_name}', comp_name).replace('{category}', category).replace('{display_name}', disp_name))

print('Master components created!')
